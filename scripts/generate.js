 ...
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} hippo - hippo color variables.
...
const transformSoft = theme => {
    ...
    const brightColors = [...soft.hippo.ansi, ...soft.hippo.brightOther];
